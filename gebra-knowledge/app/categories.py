...
CATEGORIES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "device-level technical details."
        ),
    },
    {
        "key": "math",
        ...
        "description": (
            "Search Math and Physics books, formulas, equations and reference tables."
        ),
    },
    {
        "key": "codding",
        ...
        "description": (
            "Search C/C++ Coding reference books, examples, and best practices for embedded systems and microcontrollers."
        ),
